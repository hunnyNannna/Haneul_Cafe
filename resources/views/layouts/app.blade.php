...
<body class="clinic_version">
    ...
    <!-- LOADER -->
    <div id="preloader">
        <a href="{{ url('/') }}"><img class="preloader" src="{{ config('app.url') }}images/haneul.png" style="width:200px; height:200px;" alt=""></a>
    </div>
    <!-- END LOADER -->
    <header>
        <div class="header-top wow fadeIn">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><img
                        src="{{ config('app.url') }}images/haneul.png" style="width:50px; height:50px;"
                        alt="cafe logo"></a>
                    ...
                    <div class="header-info">
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a
                                    href="tel:{{ $settings["phone"] ?? '012-4568910' }}">{{ $settings["phone"] ?? '012-4568910' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $settings["email"] ?? 'haneulcafe@gmail.com' }}">{{ $settings["email"] ?? 'haneulcafe@gmail.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-clock-o" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll href="#">Daily:
                                    {{ $settings["working_hours"] ?? '10:00 AM - 10:00 PM' }}</a></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="logo padding">
                        <a href="{{ url('/') }}"><img src="{{ 'storage/'.$settings["logo"] ??  config("app.url").'images/logo.png' }}"
                                alt=""></a>
                        <p>{{ $settings["describe"] ?? 'Looking for a Place to organize an event!'}} </p><p> We are your Solution! </p>
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker"
                                aria-hidden="true"></i>{{ $settings["location"] ?? 'Haneul Cafe, KLCC' }}
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $settings["email"] ?? 'haneulcafe@gmail.com' }}
                        </p>
                        <p><i class="fa fa-phone"
                                aria-hidden="true"></i>{{ $settings["phone"] ?? '012-4568910' }}</p>
                    </div>
                </div>
                @livewire('subscribe')
            </div>
                ...
                <div class="col-md-8">
                    <div class="footer-text">
                        <p>© {{ date('Y') }} <a id="tw" href="{{ url('') }}"
                                target="_blank">{{ env('APP_NAME') }}</a> , Org</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="social">
